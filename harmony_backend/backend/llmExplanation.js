...
- كل نقطة لا تزيد عن 35 كلمة.
- النقطة الأولى: اشرح لماذا هذا الشخص مناسب لك بناءًالسبب الاقوى وفق معلومات المشارك المقترح.
- النقطة الثانية: اشرح لماذا هذا الشخص مناسب لك بناءًالسبب الثانوي وفق معلومات المشارك المقترح.
-وفي النهاية اذكر جمله تدعم التعاون بين الطرفين بناءً على المعلومات المشتركة بينكما.
- اجباري ذكر وفق معلومات المشارك المقترح مكان عمله, اسم شركة، تخصص، نوع مشروع، نوع خبرة، أو مجال دقيق.
- استخدم تفاصيل حقيقية من النص (مثل: مكان العمل، اسم شركة، مجال دقيق، نوع خبرة) وفق معلومات المشارك المقترح.
- ركّز في تفسير الملاءمة على معلومات المشارك المقترح.
- أعطِ الأولوية دائمًا للتفاصيل المهنية والأكاديمية الدقيقة قبل الصفات العامة أو الاهتمامات.
- لا تكتب عبارات عامة مثل "خلفية قوية" أو "خبرة مميزة" من دون توضيح: أين، في ماذا، أو كيف.
- لا تذكر صفات عامة مثل: شغف، طموح، مميز، قوي، إلا إذا دعمتها بمعلومة واقعية من البيانات.
