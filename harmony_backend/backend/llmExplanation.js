...
- كل نقطة في سطر مستقل.
- كل نقطة يجب أن تتضمن معلومة ملموسة واحدة على الأقل، مثل: اسم شركة، مكان عمل، تخصص، نوع مشروع، نوع خبرة، أو مجال دقيق.
- إذا وُجدت تفاصيل دقيقة مثل اسم مؤسسة، وظيفة، أو مجال عمل، يجب ذكرها صراحة.
...
- اجعل كل نقطة مختصرة لكن غنيّة بالمعلومة، حتى 30 كلمة كحد أقصى.
...
- استخدم فقط تفاصيل حقيقية من النص.
- ركّز في تفسير الملاءمة على معلومات الشخص المقترح أولًا.
- لا تبنِ الشرح على إنجازات أو خبرات أو تفاصيل تخص المستخدم نفسه إلا إذا كانت تُستخدم فقط لتوضيح لماذا الشخص المقترح مفيد له.
